(function (factory) {
    ...
    Edit.registerUI('mathtype',function(editor,uiName){
            ...
            return ce('div',{class:'eui-dialog',style:Edit.ui.getPanelOffset(self.id)},[
                ce('div',{class:'panel-box'},[
                    ...
                    ce('div',{class:'panel-handles'},[
                        ce('span',{class:'panel-cancel'},['取消'],{click:function(){Edit.ui.closePopup();popup = null;}}),
        ...
        function insertMath() {
            ...
            if (src) {
                if (mathMark) {
                    ...
                    editor.execCommand('inserthtml','<img class="mathcode" src="'+encodeURI(src)+'" style="max-width:100%;height:auto;">');
                }                
                popup = null;
                Edit.ui.closePopup();
            }
        ...
        var floatMenu = null;
        editor.bind(editor.body, 'click', '.mathcode', function(ev){
            mathMark = ev.target;
            ...
            floatMenu = new Edit.ui.Popup({
                content: ce('div',{class:'editor-floatmenu',style:'position:absolute;left:'+ offset.left +'px;top:'+ (offset.top+mathMark.offsetHeight) +'px;'},[
                    ce('span',{},['编辑'],{
                        click: function(){
                            var mathcode = Edit.utils.parseUrl('tex',mathMark.getAttribute('src'));
        ...
        editor.bind(editor.body, 'mouseout', '.mathcode', function(ev){
            if (floatMenu) {
